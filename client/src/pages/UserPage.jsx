    ...
    <div className="container">
      <div className="row">
        <div className="col-12 py-5">
          <h1 class="text-center welcome">Welcome {user}</h1>
        </div>
      </div>
      <div className="row">
        ...
        <div className="col-3">
            ...
            <ul className="userCheckListItem">
              {list.map(item => (
                <li><Button style={{ marginLeft: "5px", border: "none", boxShadow: "-1px 0px 1px #6fadcb, 0px 1px 1px #54809d, -2px 1px 1px #6fadcb, -1px 2px 1px #54809d, -3px 2px 1px #6fadcb, -2px 3px 1px #54809d;", background: "linear-gradient(to top, #2193b0, #3a7bd5", borderRadius: "40px", fontSize: "16px", borderRadius: '4px', opacity: '.6'}} onClick={tripClick} value={item}>{item}</Button></li>
              ))}
            </ul>
